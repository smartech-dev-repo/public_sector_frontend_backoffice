    ...
    <div className="h-screen overflow-hidden bg-slate-50 font-sans flex text-slate-800">
      ...
      `}>
        ...
        <div className="p-6 space-y-8 flex-1 overflow-y-auto overflow-x-hidden">
          ...
          <Link href="/credit-risk/agent-recruitment" 
            className={`flex items-center gap-3 py-2.5 rounded-lg text-[13px] font-medium transition-all group ${
              isSidebarMinimized ? 'justify-center px-0' : 'px-3'
            } ${pathname === '/credit-risk/agent-recruitment' ? 'bg-emerald-600 text-white' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`} 
            title={isSidebarMinimized ? 'Agent Recruitment' : ''}>
            <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
            {!isSidebarMinimized && <span>Agent Recruitment</span>}
          </Link>
          ...
          <Link href="/credit-risk/customer-management" 
            className={`flex items-center gap-3 py-2.5 rounded-lg text-[13px] font-medium transition-all group ${
              isSidebarMinimized ? 'justify-center px-0' : 'px-3'
            } ${pathname === '/credit-risk/customer-management' ? 'bg-emerald-600 text-white' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`} 
            ...
            {!isSidebarMinimized && <span>Customer Management</span>}
          </Link>
          ...
          <Link href="/credit-risk/role-management" 
            className={`flex items-center gap-3 py-2.5 rounded-lg text-[13px] font-medium transition-all group ${
              isSidebarMinimized ? 'justify-center px-0' : 'px-3'
            } ${pathname === '/credit-risk/role-management' ? 'bg-emerald-600 text-white' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900'}`} 
            ...
            {!isSidebarMinimized && <span>Role management</span>}
          </Link>
