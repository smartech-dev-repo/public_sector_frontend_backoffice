  ...
  <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    <div class="max-w-[420px] w-full">
      <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center">
        ...
        <h2 class="text-2xl font-semibold text-slate-900 text-left">Set up your account</h2>
        <p class="mt-2 text-sm text-slate-500 text-left mb-6">Create a password to finish setting up your Public Sector Admin account.</p>

        <form class="space-y-4 text-left" @submit.prevent="handleActivate">
          <AuthInput
            v-model="password"
