    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
      <div className="max-w-[420px] w-full">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center">
          ...
          <h2 className="text-2xl font-semibold text-slate-900 text-left">Set up your account</h2>
          <p className="mt-2 text-sm text-slate-500 text-left mb-6">Create a password to finish setting up your Public Sector Admin account.</p>

          <form className="space-y-4 text-left" onSubmit={handleActivate}>
            <AuthInput
              value={password}
